 ...
 /**
  ...
  /**
    ...
    public void moveOutOfScreen_postiveY() {
        Position outofScreenPos = new Position(WindowConfig.tileSize * 3,
                WindowConfig.tileSize * (WindowConfig.maxScreenRow + 1));
        assertEquals(false, roomLayout.isPositionAviable(outofScreenPos));
    }
    ...
    public void moveOutOfScreen_postiveX() {
        Position outofScreenPos = new Position(WindowConfig.tileSize * (WindowConfig.maxScreenRow + 1),
                WindowConfig.tileSize);
        assertEquals(false, roomLayout.isPositionAviable(outofScreenPos));
    }
